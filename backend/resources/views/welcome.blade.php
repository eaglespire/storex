<x-guest-layout>
    <x-slot name="intro">
        <section id="intro" class="wow fadeIn">
            ...
            <div class="intro-content">
                <h2>Start  <span>Bitcoin Mining</span><br>Today!</h2>
                <div>
                    <a href="#about" class="btn-get-started scrollto">Start Mining</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="box wow fadeInLeft">
                        ...
                        <h4 class="title"><a href="">2FA Secure Login</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="box wow fadeInRight">
                        ...
                        <h4 class="title"><a href="">Stable Plans</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="box wow fadeInLeft" data-wow-delay="0.2s">
                        ...
                        <h4 class="title"><a href="">Multi Currencies</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="box wow fadeInRight" data-wow-delay="0.2s">
                        ...
                        <h4 class="title"><a href="">Reliable and Low Cost</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="box wow fadeInRight" data-wow-delay="0.2s">
                        <div class="icon"><i class="fa fa-map"></i></div>
                        <h4 class="title"><a href="">Stable Transaction Network</a></h4>
                        <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum rideta zanox satirente madera</p>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <!--==========================
      Financial Ability |Services Section
    ============================-->
    <section id="services">
        <div class="container ">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="wow fadeInRight">
                        <div class="section-header">
                            <h2>Financial Ability</h2>
                        </div>
                        <h6>Financial Ability status is updated everyday</h6>
                        <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident etiro rabeta lingo.</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-9 text-center text-lg-left">
                    <h3 class="cta-title">FAQS</h3>
                    <p class="cta-text">Frequently Asked Questions</p>
                </div>
            </div>
            <div class="row justify-content-center">
                {{--                @livewire('faqs')--}}
