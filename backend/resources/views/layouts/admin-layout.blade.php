            ...
            <nav class="mt-4 py-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item mb-2 active">
                        <a href="{{ route('admin.site') }}" class="nav-link {{ checkCurrentRoute('admin.site') }}">
                            <i class="far fa-circle nav-icon text-primary"></i>
                            <p>Site Data</p>
                        </a>
                    </li>
                    {{--<li class="nav-item mb-2">
                        <a href="./index2.html" class="nav-link {{ set_active_link_in_dashboard('admin.accounts') }} ">
                            <i class="far fa-circle nav-icon text-primary"></i>
                            <p>Manage Users</p>
                        </a>
                    </li>--}}
                    <li class="nav-item mb-2">
                        <a href="{{ route('admin.accounts') }}" class="nav-link {{ checkCurrentRoute('admin.accounts') }}">
                            <i class="far fa-circle nav-icon text-primary"></i>
